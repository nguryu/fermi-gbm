...
with open(path+'swift_within_saa1.txt', 'w') as outfile1:
...
with open(path+'swift_not_visible1.txt', 'w') as outfile2:
...
with open(path+'swift_visible.txt1', 'w') as outfile3:
