...
# Edit the date in line 45 to a specific date if you want to download position history data for that one day.
# Edit the '==' operator to '>=' in line 45 if you want to download data continuously after the designated date.
